...
const QuizSetting = (props) => {
  ...
  return (
    <>
    <Button variant="contained" onClick={()=>{setDrawerOpen(true); setHeight("600px") }} >
        Quiz Settings
    </Button>
    <SwipeableDrawer anchor="top" open={isDrawerOpen} onClose={()=>{setDrawerOpen(false)}} >
        <Box p={2}  sx={{ width:  'auto', height:{height} }} role="presentation" textAlign="center" >
        <Box component="form" sx={{'& .MuiTextField-root': { m: 1, width: '25ch' },}} noValidate autoComplete="off">   
           <div >
                ...
                <TextField
                    ...
                    <div style={{position:"relative"}} >
                      ...
                      <TextField
                        ...
                        <InputLabel htmlFor="component-simple">Check if* Quiz is MCQ type. 
                            <Checkbox 
                            name="isMcq"
                            id="isMcq"
                            type="checkbox"
                    ...
                    <InputLabel htmlFor="component-simple">Specify Time per question</InputLabel>
                    <TextField
                        required
                        type="number"
                ...
                <Button variant="contained"  onClick={handleClick}>{height === "800px" ? "Add Settings and Close Tab" : "Update Settings"}</Button>
              </div>
         </Box>
        </Box>
    </SwipeableDrawer>
